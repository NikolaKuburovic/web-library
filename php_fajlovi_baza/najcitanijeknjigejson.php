...
if(checkIfLoggedIn()){
	$upit = mysql_query("SELECT KNJIGA_NASLOV, KNJIGA_BROJ_STRANA, PISAC.PISAC_ID, PISAC.PISAC_IME, PISAC.PISAC_PREZIME, IZDAVAC.IZDAVAC_NAZIV,
    ...
    ORDER BY KNJIGA_BR_PREGLEDA DESC LIMIT 12") or die('greska');
	$redovi = array();
