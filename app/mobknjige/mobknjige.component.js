System.register(['angular2/core', 'angular2/common', 'angular2/router', 'angular2/http', 'rxjs/Rx'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            MobknjigeComponent = (function () {
                function MobknjigeComponent(builder, router, http) {
                    this.router = router;
                    this.http = http;
                }
                MobknjigeComponent.prototype.ngOnInit = function () {
                    this.moblista();
                };
                MobknjigeComponent.prototype.moblista = function () {
                    var _this = this;
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/x-www-form-urlencoded');
                    headers.append('token', localStorage.getItem('token'));
                    this.http.get('http://localhost/WebBiblioteka/mobknjigejson.php', { headers: headers })
                        .map(function (res) { return res.json(); }).share()
                        .subscribe(function (mobknjige) {
                        _this.mobknjige = mobknjige;
                    }, function (err) {
                ...
                //-------------------------------------------------------
                MobknjigeComponent.prototype.brojpregleda = function (knjigaIsbn, pisacId) {
                    var _this = this;
                    var data = knjigaIsbn;
                    var data2 = pisacId;
                    var headers = new http_1.Headers();
                ...
                MobknjigeComponent = __decorate([
                    core_1.Component({
                        selector: 'Mobknjige',
                        templateUrl: 'app/mobknjige/mobknjige.html',
                        directives: [router_1.ROUTER_DIRECTIVES, common_1.FORM_DIRECTIVES],
                        viewBindings: [common_1.FORM_BINDINGS]
                    }), 
                    __metadata('design:paramtypes', [common_1.FormBuilder, router_1.Router, http_1.Http])
                ], MobknjigeComponent);
                return MobknjigeComponent;
            }());
            exports_1("MobknjigeComponent", MobknjigeComponent);
        }
    }
});
//# sourceMappingURL=mobknjige.component.js.map