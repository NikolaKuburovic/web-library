System.register(['angular2/core', 'angular2/common', 'angular2/router', 'angular2/http', 'rxjs/Rx'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            WebknjigeComponent = (function () {
                function WebknjigeComponent(builder, router, http) {
                    this.router = router;
                    this.http = http;
                }
                WebknjigeComponent.prototype.ngOnInit = function () {
                    this.weblista();
                };
                WebknjigeComponent.prototype.weblista = function () {
                    var _this = this;
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/x-www-form-urlencoded');
                    headers.append('token', localStorage.getItem('token'));
                    this.http.get('http://localhost/WebBiblioteka/webknjigejson.php', { headers: headers })
                        .map(function (res) { return res.json(); }).share()
                        .subscribe(function (webknjige) {
                        _this.webknjige = webknjige;
                    }, function (err) {
                ...
                //-------------------------------------------------------
                WebknjigeComponent.prototype.brojpregleda = function (knjigaIsbn, pisacId) {
                    var _this = this;
                    var data = knjigaIsbn;
                    var data2 = pisacId;
                    var headers = new http_1.Headers();
                ...
                WebknjigeComponent = __decorate([
                    core_1.Component({
                        selector: 'Webknjige',
                        templateUrl: 'app/webknjige/webknjige.html',
                        directives: [router_1.ROUTER_DIRECTIVES, common_1.FORM_DIRECTIVES],
                        viewBindings: [common_1.FORM_BINDINGS]
                    }), 
                    __metadata('design:paramtypes', [common_1.FormBuilder, router_1.Router, http_1.Http])
                ], WebknjigeComponent);
                return WebknjigeComponent;
            }());
            exports_1("WebknjigeComponent", WebknjigeComponent);
        }
    }
});
//# sourceMappingURL=webknjige.component.js.map